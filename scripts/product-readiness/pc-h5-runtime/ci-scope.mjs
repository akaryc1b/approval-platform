...
const relevantPaths = [
  ...
  /^apps\/web\/overlay\/playground\/(?:__tests__\/e2e\/(?:product-readiness-pc-h5-runtime(?:-(?:api|diagnostics|ui)|\.spec)|product-readiness-h5-payment-runtime\.spec|product-readiness-quick-start-ready\.spec)\.ts|product-readiness\.playwright\.config\.ts)$/u,
  /^config\/demo\/purchase-payment-alpha-acceptance\.json$/u,
  /^config\/demo\/quick-start\.json$/u,
  /^config\/demo\//u,
  /^scripts\/product-readiness\/(?:demo-backend|demo-client|demo-quickstart|pc-h5-runtime-smoke|purchase-payment-e2e|purchase-payment-scenario-contract)\.mjs$/u,
  ...
  /^scripts\/tests\/(?:m3-repository-hygiene|product-readiness-pc-h5-runtime-boundary|product-readiness-purchase-payment-e2e-boundary|product-readiness-quick-start-boundary)\.test\.mjs$/u,

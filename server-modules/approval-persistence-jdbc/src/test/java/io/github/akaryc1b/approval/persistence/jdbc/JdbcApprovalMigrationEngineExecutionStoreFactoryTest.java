...
class JdbcApprovalMigrationEngineExecutionStoreFactoryTest {

    @Test
    void selectsExistingPostgreSqlExecutionAuthorityFromTrustedMetadata() {
        DataSource dataSource = dataSource("PostgreSQL", "16.6", 16, 6);
        ApprovalMigrationEngineExecutionStore store =
        ...
        assertInstanceOf(JdbcApprovalMigrationEngineExecutionStore.class, store);
    }

    @Test
    void selectsMySqlExecutionAuthorityFromTrustedMetadata() {
        ...
        assertInstanceOf(JdbcMySqlApprovalMigrationEngineExecutionStore.class, store);
    }

...
class JdbcApprovalReleaseFoundationStoreFactoryTest {
    ...
    void selectsAcceptedPostgreSqlImplementationsFromMetadata() {
        ...
        assertInstanceOf(
            JdbcApprovalReleasePackageStore.class,
            JdbcApprovalReleasePackageStoreFactory.create(dataSource)
        );
        assertInstanceOf(
            JdbcApprovalReleaseDeploymentStore.class,
    ...
    void selectsMySqlImplementationsFromMetadata() {
        ...
        assertInstanceOf(
            JdbcMySqlApprovalReleasePackageStore.class,
            JdbcApprovalReleasePackageStoreFactory.create(dataSource)
        );
        assertInstanceOf(
            JdbcMySqlApprovalReleaseDeploymentStore.class,
            JdbcApprovalReleaseDeploymentStoreFactory.create(dataSource)
        );
    }

...
class JdbcApprovalAssistanceDurableEvidenceStoreFactoryTest {

    @Test
    void selectsPostgreSqlP4AuthorityFromTrustedMetadata() {
        ...
        assertInstanceOf(JdbcApprovalAssistanceDurableEvidenceStore.class, store);
    }

    @Test
    void selectsMySqlP4AuthorityFromTrustedMetadata() {

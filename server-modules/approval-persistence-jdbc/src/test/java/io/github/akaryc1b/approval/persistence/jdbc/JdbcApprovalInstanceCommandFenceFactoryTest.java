...
class JdbcApprovalInstanceCommandFenceFactoryTest {

    @Test
    void selectsPostgreSqlFenceFromTrustedMetadata() {
        assertInstanceOf(
            JdbcApprovalInstanceCommandFence.class,
            JdbcApprovalInstanceCommandFenceFactory.create(
    ...
    @Test
    void selectsMySqlFenceFromTrustedMetadata() {
        assertInstanceOf(
            JdbcMySqlApprovalInstanceCommandFence.class,
            JdbcApprovalInstanceCommandFenceFactory.create(

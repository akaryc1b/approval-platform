...
class JdbcApprovalProjectionStoreFactoryTest {

    @Test
    void selectsTheAcceptedPostgreSqlImplementationFromMetadata() {
        assertInstanceOf(
            JdbcApprovalProjectionStore.class,
            JdbcApprovalProjectionStoreFactory.create(
    ...
    void selectsTheMySqlImplementationFromMetadata() {
        assertInstanceOf(
            JdbcMySqlApprovalProjectionStore.class,
            JdbcApprovalProjectionStoreFactory.create(

...
class JdbcApprovalMigrationRuntimeBindingCasStoreFactoryTest {

    @Test
    void selectsPostgreSqlSerializedAuthorityFromTrustedMetadata() {
        ...
        assertInstanceOf(
            PostgresSerializedApprovalMigrationRuntimeBindingCasStore.class,
            store
        );
    }

    @Test
    void selectsMySqlCompletionAuthorityFromTrustedMetadata() {
        ...
        assertInstanceOf(
            JdbcMySqlApprovalMigrationRuntimeBindingCasStore.class,
            store
        );
    }

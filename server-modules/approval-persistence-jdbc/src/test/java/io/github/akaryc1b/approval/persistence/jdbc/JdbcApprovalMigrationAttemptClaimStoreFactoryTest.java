...
class JdbcApprovalMigrationAttemptClaimStoreFactoryTest {

    @Test
    void selectsExistingPostgreSqlClaimAuthorityFromTrustedMetadata() {
        DataSource dataSource = dataSource("PostgreSQL", "16.6", 16, 6);
        ApprovalMigrationAttemptClaimStore store =
        ...
        assertInstanceOf(JdbcApprovalMigrationAttemptClaimStore.class, store);
    }

    @Test
    void selectsMySqlClaimAuthorityFromTrustedMetadata() {
        ...
        assertInstanceOf(JdbcMySqlApprovalMigrationAttemptClaimStore.class, store);
    }

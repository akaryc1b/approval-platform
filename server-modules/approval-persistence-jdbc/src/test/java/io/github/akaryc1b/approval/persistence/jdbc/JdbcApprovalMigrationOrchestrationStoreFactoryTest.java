...
class JdbcApprovalMigrationOrchestrationStoreFactoryTest {

    @Test
    void selectsPostgreSqlD7AuthorityFromTrustedMetadata() {
        ...
        assertInstanceOf(JdbcApprovalMigrationOrchestrationStore.class, store);
    }

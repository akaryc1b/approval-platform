...
class JdbcApprovalMigrationPlanAggregationStoreFactoryTest {

    @Test
    void selectsSerializedPostgreSqlD8AuthorityFromTrustedMetadata() {
        ...
        assertInstanceOf(
            PostgresSerializedApprovalMigrationPlanAggregationStore.class,
            store
        );
    }

    @Test
    void selectsCanonicalMySqlD8AuthorityFromTrustedMetadata() {

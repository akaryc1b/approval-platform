...
class JdbcApprovalFormPackageStoreFactoryTest {

    @Test
    void selectsTheAcceptedPostgreSqlImplementationFromMetadata() {
        assertInstanceOf(
            JdbcApprovalFormPackageStore.class,
            JdbcApprovalFormPackageStoreFactory.create(
    ...
    void selectsTheMySqlImplementationFromMetadata() {
        assertInstanceOf(
            JdbcMySqlApprovalFormPackageStore.class,
            JdbcApprovalFormPackageStoreFactory.create(

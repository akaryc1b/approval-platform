...
class JdbcApprovalMigrationAttemptProvisioningStoreFactoryTest {

    @Test
    void selectsExistingPostgreSqlProvisioningAuthorityFromTrustedMetadata() {
        DataSource dataSource = dataSource("PostgreSQL", "16.6", 16, 6);
        ApprovalMigrationAttemptProvisioningStore store =
        ...
        assertInstanceOf(JdbcApprovalMigrationAttemptProvisioningStore.class, store);
    }

    @Test
    void selectsMySqlProvisioningAuthorityFromTrustedMetadata() {
        ...
        assertInstanceOf(JdbcMySqlApprovalMigrationAttemptProvisioningStore.class, store);
    }

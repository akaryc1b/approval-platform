...
class JdbcApprovalMigrationReconciliationExecutionStoreFactoryTest {

    @Test
    void selectsPostgreSqlD6AuthorityFromTrustedMetadata() {
        ...
        assertInstanceOf(
            JdbcApprovalMigrationReconciliationExecutionStore.class,
            store
        );
    }

    @Test
    void selectsMySqlD6AuthorityFromTrustedMetadata() {

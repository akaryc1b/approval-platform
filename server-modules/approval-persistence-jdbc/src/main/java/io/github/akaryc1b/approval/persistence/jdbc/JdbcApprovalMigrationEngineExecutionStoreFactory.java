...
/** Trusted metadata-driven migration engine execution-store selection. */
public final class JdbcApprovalMigrationEngineExecutionStoreFactory {

    private JdbcApprovalMigrationEngineExecutionStoreFactory() {
    }

    public static ApprovalMigrationEngineExecutionStore create(

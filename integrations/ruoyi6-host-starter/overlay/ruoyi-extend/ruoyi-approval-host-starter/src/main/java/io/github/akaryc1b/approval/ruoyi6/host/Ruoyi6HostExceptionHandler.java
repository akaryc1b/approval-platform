...
@RestControllerAdvice(assignableTypes = Ruoyi6ApprovalHostController.class)
public final class Ruoyi6HostExceptionHandler {
    ...
    @ExceptionHandler(Ruoyi6HostException.class)
    public ResponseEntity<HostErrorResponse> adapter(
        Ruoyi6HostException exception,
        HttpServletRequest request
    ) {
        return response(
            exception.status(),

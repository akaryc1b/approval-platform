...
/**
 * Adds the service-to-service connector path to RuoYi's login-interceptor exclusions.
 */
final class Ruoyi5SecurityExclusionPostProcessor implements BeanPostProcessor {
